...
# otras
stem_a1 -> prs    [a:]      [tam=[-sub,-ipf,-cnd,-imv,+tmp],sj=[-2]];[tam=[-sub,-ipf,-cnd,-imv,+tmp],sj=[+p]]
stem_e1 -> prs    [e:]      [tam=[-sub,-ipf,-cnd,-imv,+tmp],sj=[-2]];[tam=[-sub,-ipf,-cnd,-imv,+tmp],sj=[+p]]
# becomes e when not stressed
stem_i1 -> prs    [I:]      [tam=[-sub,-ipf,-cnd,-imv,+tmp],sj=[-2]];[tam=[-sub,-ipf,-cnd,-imv,+tmp],sj=[+p]]
...
a_sub_prs1 -> person <'e:>   [tam=[+sub,+tmp,-ger,-part,-inf,-imv],sj=[+1,+p]]
e_sub_prs1 -> person <`a:>   [tam=[+sub,+tmp,-ger,-part,-inf,-imv],sj=[-2]];[tam=[+sub,+tmp,-ger,-part,-inf,-imv],sj=[+1,-p]]
e_sub_prs1 -> person <'a:>   [tam=[+sub,+tmp,-ger,-part,-inf,-imv],sj=[+1,+p]]
...
stem_e1 -> pps       <id:>
stem_i1 -> pps       <id:>
pps -> adjsuff      [:]    [tam=[-imv,-ipf,-sub,-tmp,-ger,+part,-inf],-refl,oi=[-xpl],od=[-xpl]]
...
person -> postpron [n:]    [sj=[-1,+p],tam=[+sub,-prt]]
