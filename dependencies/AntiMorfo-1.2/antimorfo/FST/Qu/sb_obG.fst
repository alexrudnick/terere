...
# start -> plur     <sun:>   [sb=[+p1,+p2,+pl],ob=[-p1,-p2,-xpl],tam=[-ps,-pp,-im],m=[AGR2=sun]];[ob=[+p1,+p2,+pl,+xpl],sb=[-p1,-p2],tam=[-ps,-pp,-im],m=[AGR2=sun]]
# Intransitive 3 (except fut and imp); intransitive 1pi; transitive 3->1 (wa...n), except fut
start -> plur     [n:]     [-tr,sb=[-p1,-p2],tam=[-ft,-im],m=[AGR2=n]];[-tr,sb=[+p1,+p2,+pl],m=[AGR2=n]];[sb=[-p1,-p2],ob=[+p1,+xpl],tam=[-ft,-im],m=[AGR2=n]]
# Future 3, 3->
start -> plur     <nqa:>   [sb=[-p1,-p2],ob=[-p2],tam=[+ft,-ps,-pp,-cd,-im],m=[AGR2=nqa]]
...
# Conditional 2 intr
start -> plur     <waq:>   [-tr,sb=[-p1,+p2],tam=[+cd,-ft,-ps,-pp,-im],m=[AGR2=waq]]
...
# ONLY -chis FOR GENERATION (NO -chik)
pl_chi -> end     [s:]     [m=[AGR3=chis]]
