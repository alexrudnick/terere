...
nder2 -> nom_sbj   <lla:>         [pos=n,rpos=n,pos2=adj,der=[+lim],cs=[-dstr,-intrc,-trm],m=[DER2=lla]]
nder2 -> case      <lla:>         [pos=adj,rpos=adj,pos2=adj,der=[+lim],cs=[-dstr,-intrc,-trm],m=[DER2=lla]]
# Adjectives with no more der suffixes
nder2 -> case      [:]            [pos=adj,rpos=adj,pos2=adj,der=[-lim]]
...
## No derivational suffix; common nouns/adjectives (to distinguish from pronouns)
...
# Infinitive, can't be plural?
vder2 -> case      [y:]           [pos=n,pos2=inf,m=[NOM=y]]
# "Agent", can be plural
vder2 -> num       [q:]           [pos=n,pos2=agt,m=[NOM=q]]

### ASPECT (only PROGRESSIVE)
# not possible for nominalized forms
vder2 -> trans     <sha:>         [pos=v,pos2=v,asp=[+prg],cs=None,m=[ASP=sha]]
# not nominalized here, but could be later
vder2 -> trans     [:]            [pos=v,asp=[-prg]];[pos=n,asp=[-prg]]
...
# Past: r(q)a
tam -> ps1         [r:]           [pos=v,pos2=v,cs=None,tam=[+ps,-pp,-ft,-cd,-im],m=[TM1=rqa]]
ps1 -> ps2         [q:;:]
ps2 -> sb_ob       [a:]
# Past perfect
...
# tam -> sb_ob [:] [pos=v,pos2=v,cs=None,tam=[-ps,-pp,-ft,-cd]];[pos=v,pos2=v,cs=None,tam=[-ps,-pp,-im],sb=[-p1]];[pos=v,pos2=v,cs=None,tam=[-ps,-pp,-im],sb=[+p1,+p2],ob=[-xpl]]
